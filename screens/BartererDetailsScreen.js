  ...
  return(
      <View style={styles.container}>
          ...
          {/* <View style={styles.container}>
              ...
              ?
              (<TouchableOpacity style={styles.registerButton} onPress={()=>{this.updateBookStatus,this.props.navigation.navigate('MyDonations')}}>
                  <Text style={styles.registerButtonText}> I Want To Donate </Text>
              </TouchableOpacity> ) :
              null
              }
          </View> */}
